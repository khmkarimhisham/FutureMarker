                ...
                <div class="card -row my-5" style=" border-radius: 25px;">
                    <div class="card-body">
                        <div class="text-center">
                            <!--hena ya martin t7ot el image bta3t el course-->
                            <img src="images/course.png" width="240" height="240" class="avatar img-circle img-thumbnail" alt="avatar">
                        </div>
                        </hr><br>
                        <div>
                            <hr class="my-2">
                ...
                <div class="card -row my-5" style=" border-radius: 25px;">
                    ...
                    <table class="table table-sm table-light ">
                         <!--hena ya martin el tag eli hatkrr wtab3n hatdef el image bta3t eluser e esmo-->
                                <tr class="table-active "><img src="http://www.bobmazzo.com/wp-content/uploads/2009/07/bobmazzoCD.jpg" width="30" height="30"><a href="#" class="aedit">Anas Hassan</a> </tr>
                                <hr class="my-2 ">
                                <tr class="table-active "><img src="http://www.bobmazzo.com/wp-content/uploads/2009/07/bobmazzoCD.jpg" width="30" height="30"><a href="#" class="aedit">Martin Fawzy</a> </tr>
                                <hr class="my-2 ">
                                <tr class="table-active "><img src="http://www.bobmazzo.com/wp-content/uploads/2009/07/bobmazzoCD.jpg" width="30" height="30"><a href="#" class="aedit">Karim Hisham</a> </tr>
                                <hr class="my-2 ">
                                <tr class="table-active "><img src="http://www.bobmazzo.com/wp-content/uploads/2009/07/bobmazzoCD.jpg" width="30" height="30"><a href="#" class="aedit">Mohamed Essam</a> </tr>
                                <hr class="my-2 ">
