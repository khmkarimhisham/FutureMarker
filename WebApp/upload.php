...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($_POST['Select'] == 1) {
        ...
        if (isset($_FILES["Ufile"]["name"])) {
            ...
            $upload_check = move_uploaded_file($_FILES["Ufile"]["tmp_name"], $target);
        }        
        header("Location: course_content_i.php?course_id=$Course_ID&upload=$upload_check");
