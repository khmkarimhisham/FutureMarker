...
<div class="row">
    ...
    <div class="col-md-9">
        <div class="card">
            <div class="card-body">
                <h4><strong><a href="{{ route('instrutor.userprofile',$finishedAssignment->user['id']) }}"><img
                                src="{{ asset($finishedAssignment->user['image']) }}" width="30" height="30">
                            {{ $finishedAssignment->user['name'] }}</a> ➥ {{ $assignment['assignment_title'] }}
                        Feedback</strong></h4>
