...
<body>
    <nav class="navbar navbar-expand-sm navbar-dark">
        <!-- Brand -->
        <a class="navbar-brand pt-0" href="{{ route('student') }}">
        ...
        <ul class="navbar-nav ml-auto navbar-icons d-flex flex-row order-2 order-sm-3">
            ...
            <li class="nav-item dropdown  d-none d-sm-block">
                ...
                <div class="dropdown-menu dropdown-menu-right dropdown-default"
                    ...
                    <a class="dropdown-item" href="{{ route('student.profile') }}"><i class="fa fa-user"
        ...
        <div class="collapse navbar-collapse order-3 order-sm-2" id="collapsibleNavbar">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('student.grades') }}">Grades</a>
                </li>
